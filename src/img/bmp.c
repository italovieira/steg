...
BMP* read_bmp(const char *filename)
{
  ...
  printf("%u ", header->reserved1);
  printf("%u ", header->reserved2);
  ...
  printf("%d ", header_info->size);
  printf("%d ", header_info->x);
  printf("%d ", header_info->y);
  printf("%d ", header_info->planes);
  printf("%d ", header_info->bit_count);
  printf("%d ", header_info->compression);
  printf("%d ", header_info->img_size);
  printf("%d ", header_info->xresolution);
  printf("%d ", header_info->yresolution);
  printf("%d ", header_info->colors_used);
  printf("%d ", header_info->colors_important);
  printf("\n");
